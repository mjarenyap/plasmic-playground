...
import sty from "./PlasmicStatistic.module.css"; // plasmic-import: iGqX1x8hlVRp/css
...
function PlasmicStatistic__RenderFunc(props: {
  ...
  return (
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__gnB0C)}>
            <p
              className={classNames(
                projectcss.all,
                projectcss.p,
            ...
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__fNd8T, {
                [sty.imghideIcon__fNd8Tt2JWr]: hasVariant(
                  $state,
                  "hideIcon",
                  "hideIcon"
                )
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__hDzEc)}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__wvp, {
            [sty.freeBoxhideIcon__wvpT2JWr]: hasVariant(
              $state,
              "hideIcon",
              "hideIcon"
            )
        ...
        <div className={classNames(projectcss.all, sty.freeBox__hMyqR)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__maW9Q, {
              [sty.freeBoxhideTrendTracker__maW9QmRu0V]: hasVariant(
                $state,
                "hideTrendTracker",
                "hideTrendTracker"
              )
          ...
          >
            <div
              className={classNames(projectcss.all, sty.freeBox__iwr2N, {
                [sty.freeBoxhideTrendTracker__iwr2NmRu0V]: hasVariant(
                  $state,
                  "hideTrendTracker",
                  "hideTrendTracker"
                )
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__kHAms)}>
                {p.renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.freeBox__rs8Yb)}>
              <div className={classNames(projectcss.all, sty.freeBox__pkric)}>
                {p.renderPlasmicSlot({
