...
import sty from "./PlasmicDateTimeRangePicker.module.css"; // plasmic-import: SpkwBTn_y8pG/css
            ...
            <React.Fragment>
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker__ruDmx
                  ),
                  picker: "date",
                  popupScopeClassName:
                    sty["dateTimePicker__ruDmx__datePickerPopup"],
                  showTime: false
                };
              ...
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker___0S2W
                  ),
                  popupScopeClassName:
                    sty["dateTimePicker___0S2W__datePickerPopup"],
                  showTime: false
                };
